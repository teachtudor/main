...
//   const [heldAnimation, setHeldAnimation] = useState(null);
...
//             animationTrigger={heldAnimation}      
//             onReady={() => setAnimationsReady(true)}
//             hudOpen ={hudOpen}
//           />
//           <GroundPlane />
//           <GLBModel url="/testbath.glb" position={[9.1, 0.1, -1.39]} scale={2.8} rotation={[0, Math.PI / 3, 0]} />
...
//       {/* {animationsReady && (
//         // <RadialHUD onSelect={(animationName) => {
//         //   setAnimationTrigger(animationName);
//         // }} />
//         <RadialHUD onSelect={(animationName) => {
//           setAnimationTrigger(null);  // force clear first
//           setTimeout(() => {
//             setAnimationTrigger(animationName);
//           }, 10);  // slight delay ensures trigger refreshes
//         }} />
        
//       )} */}
//       {animationsReady && (
//         // <RadialHUD onSelect={(animationName) => {
//         //   setHeldAnimation(animationName);  // updates on press/release
//         // }} />

//         <RadialHUD 
//           onSelect={setHeldAnimation} 
//           hudOpen={hudOpen} 
