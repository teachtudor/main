...
//   // Corrected: Single useEffect to handle multiple intervals for word updates
//   useEffect(() => {
//     if (!wordList.length) return;

//     const intervals = anchorPoints.map((_, index) => {
//       return setInterval(() => {
//         const randomIndex = Math.floor(Math.random() * wordList.length);
//         const word = wordList[randomIndex];
...
//   // Once grid and wordList are loaded, set up anchor points within walkable paths
//   useEffect(() => {
//     if (!grid.length || !wordList.length) return;
...
//         if (grid[y][x] === 0) {
//           pathPositions.push({ x, y: 5, z: y });  // y=5 for floating height
//         }
//       }
//     }

//     const maxAnchors = Math.min(300, pathPositions.length);
//     const sampledAnchors = [];

//     while (sampledAnchors.length < maxAnchors) {
//       const randIndex = Math.floor(Math.random() * pathPositions.length);
//       sampledAnchors.push(pathPositions[randIndex]);
//     }

//     setAnchorPoints(sampledAnchors);
//     setCurrentWords(new Array(sampledAnchors.length).fill(null));
//   }, [grid, wordList]);

//   // For each anchor point, rotate through words
//   useEffect(() => {
//     if (!anchorPoints.length || !wordList.length) return;
...
//       {/* Show/Hide Path Button */}
//       <button
//         onClick={(e) => { e.preventDefault(); setShowPath(prev => !prev); }}
//         onTouchStart={(e) => e.preventDefault()}
//         onContextMenu={(e) => e.preventDefault()}
//         style={{
//           position: 'absolute',
//           top: 20, right: 20, zIndex: 1000,
...
//       {/* Toggle Glow */}
//       <button
//         onClick={(e) => { e.preventDefault(); setLightOn(prev => !prev); }}
//         onTouchStart={(e) => e.preventDefault()}
//         onContextMenu={(e) => e.preventDefault()}
//         style={{
//           position: 'absolute',
//           top: 70, right: 20, zIndex: 1000,
//           padding: '10px 20px', fontSize: '16px',
//           background: '#fff', border: '1px solid #ccc',
//           borderRadius: '8px', cursor: 'pointer',
//           userSelect: 'none', touchAction: 'none'
...
//       {/* Toggle Music */}
//       <button
//         onClick={(e) => { e.preventDefault(); setMusicMuted(prev => !prev); }}
//         onTouchStart={(e) => e.preventDefault()}
//         onContextMenu={(e) => e.preventDefault()}
//         style={{
//           position: 'absolute',
//           top: 120, right: 20, zIndex: 1000,
//           padding: '10px 20px', fontSize: '16px',
//           background: '#fff', border: '1px solid #ccc',
//           borderRadius: '8px', cursor: 'pointer',
//           userSelect: 'none', touchAction: 'none'
...
export default function MazePage() {
  ...
  const wallBoxes = useMemo(() => (
    grid.length > 0 ? generateWallBoxes(grid) : []
  ), [grid]);
